        ...
        <section class="p-index-main">
            <div class="p-index-flow">
                <ul class="p-index-flow-liststep">
                    ...
                    <li class="p-index-flow-listitem step4 is-active"><span>STEP 4</span><br>発行依頼完了</li>
                </ul>
            </div>
            <section class="p-index-block">
                <h3 class="p-index-block__ttl">アカウント発行依頼完了</h3>
                <p class="p-index-block__text">登録いただいたメールアドレス宛に、「住宅省エネ2023キャンペーン住宅省エネポータル」ログインURL、ユーザID、仮パスワードが記載されたアカウント発行通知メールを1～2時間程度でお送りします。<br>
                    ただし午前1:30～午前5:30に実施されたアカウント発行依頼は、午前6:00頃より順次メールが配されます。<br>
                    アカウント発行依頼が集中した場合には、平日は翌日対応、週末は週明けに順次対応となる場合がございます。</p>
