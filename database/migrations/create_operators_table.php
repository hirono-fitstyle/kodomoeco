...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('operators', function (Blueprint $table) {
            ...
            $table->boolean('public_project1')->nullable()->comment('公開情報 参加補助金事業（子育てエコホーム）');
            $table->boolean('public_project2')->nullable()->comment('公開情報 参加補助金事業（給湯省エネ）');
            $table->boolean('public_project3')->nullable()->comment('公開情報 参加補助金事業（先進的窓リノベ）');
            $table->boolean('public_project3')->nullable()->comment('公開情報 参加補助金事業（賃貸集合給湯省エネ）');
            ...
            $table->boolean('public_project_abolish_flag1')->nullable()->comment('公開情報 参加補助金事業（子育てエコホーム）廃止フラグ');
            $table->boolean('public_project_abolish_flag2')->nullable()->comment('公開情報 参加補助金事業（給湯省エネ）廃止フラグ');
            $table->boolean('public_project_abolish_flag3')->nullable()->comment('公開情報 参加補助金事業（先進的窓リノベ）廃止フラグ');
            $table->boolean('public_project_abolish_flag3')->nullable()->comment('公開情報 参加補助金事業（賃貸集合給湯省エネ）廃止フラグ');
